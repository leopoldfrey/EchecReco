...
void receiveOsc() {
  ...
  if (size > 0) {
    ...
    if (!msg.hasError()) {
      msg.dispatch("/trywifi/led", oscLed);
      msg.dispatch("/trywifi/test", oscTest);
      msg.dispatch("/trywifi/bright", oscBright);
      msg.dispatch("/trywifi/feed", oscFeed);
      msg.dispatch("/trywifi/thru", midiThru);
      msg.dispatch("/trywifi/midiOut", midiOut);
      msg.dispatch("/trywifi/motor1", oscMotor1);
      msg.dispatch("/trywifi/motor2", oscMotor2);
      msg.dispatch("/trywifi/motor3", oscMotor3);
      msg.dispatch("/trywifi/motor4", oscMotor4);
      msg.dispatch("/trywifi/relay1", oscRelay1);
      msg.dispatch("/trywifi/relay2", oscRelay2);
